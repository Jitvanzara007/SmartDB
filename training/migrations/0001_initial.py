# Generated by Django 4.2.7 on 2025-06-30 04:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('instructor', 'Instructor'), ('trainee', 'Trainee')], default='trainee', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trainee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assigned_modules', to=settings.AUTH_USER_MODEL)),
            ],
            options={
