    ...
    <div className="main-content" style={{ background: '#181b20', minHeight: '100vh', padding: 0 }}>
      ...
      <div className="dashboard-grid">
        <div className="dashboard-card">
          <h3 className="card-title">Total Trainees</h3>
          <div className="stat-number">{total_trainees}</div>
          <div className="stat-label">Registered Trainees</div>
        </div>
        
        <div className="dashboard-card">
          <h3 className="card-title">Training Modules</h3>
          <div className="stat-number">{total_modules}</div>
          <div className="stat-label">Available Modules</div>
        </div>
        
        <div className="dashboard-card">
          <h3 className="card-title">Active Modules</h3>
          <div className="stat-number">{modules.filter(m => m.is_active).length}</div>
          <div className="stat-label">Currently Active</div>
        </div>
        
        <div className="dashboard-card">
          <h3 className="card-title">Avg Completion</h3>
